...
export const LIKE_POST = gql`
    mutation likePost($id: String!, $description: String!, $newLikedBy: [String!]!, $postOwner: String!, $comments: [String!]!, $liked: Boolean!) {
      likePost(like: {id: $id, description: $description, newLikedBy: $newLikedBy, postOwner: $postOwner, comments: $comments, liked: $liked})
    }
  `;
